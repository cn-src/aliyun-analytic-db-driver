 ...
 * @author zhangpeng
 */
public class AnalyticDbJdbc4Connection extends AnalyticDbConnection
{
    private JDBC4ClientInfoProvider infoProvider;
    
    public AnalyticDbJdbc4Connection(String hostToConnectTo, int portToConnectTo, Properties info,
